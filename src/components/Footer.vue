<template>
  <div class="cookies" id="bandeau-cookies">
    <div class="row">
      ...
      <div class="col-md-2 responsive text-center">
        <a
          href="http://marketing.cellar.services.clever-cloud.com/Legal_information/Data%20protection%20policy%20of%20the%20website.pdf"
          target="_blank"
          class="btn btn-GB"
          >{{ $t("cookies_more_info") }}</a
        >
      </div>
    </div>
  </div>
